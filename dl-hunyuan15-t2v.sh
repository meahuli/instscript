#!/usr/bin/env bash
# ============================================================
# HunyuanVideo 1.5 720p T2V workflow + models.
# Source workflow:
#   https://comfy.org/workflows/download/a3e50e79cb89.json?filename=video_hunyuan_video_1.5_720p_t2v
#
# Run:  bash /workspace/instscript/dl-hunyuan15-t2v.sh
#       WITH_SR=1 bash /workspace/instscript/dl-hunyuan15-t2v.sh
#
# Default downloads only the 720p T2V path used by the workflow. WITH_SR=1 also
...
WF_URL="https://comfy.org/workflows/download/a3e50e79cb89.json?filename=video_hunyuan_video_1.5_720p_t2v"
WF_NAME="video_hunyuan_video_1.5_720p_t2v.json"
...
# Required 720p T2V assets.
get "$HV15/diffusion_models/hunyuanvideo1.5_720p_t2v_fp16.safetensors" diffusion_models hunyuanvideo1.5_720p_t2v_fp16.safetensors
...
echo ""
echo "HunyuanVideo 1.5 720p T2V ready in $MODELS_DIR"
